...
export class Navigation extends BasePage {
  private readonly storesPage = this.page
    .getByRole("link", { name: "Stores" })
    .first();
  private readonly wellzonesPage = this.page
    .getByRole("link", { name: "Wellzones" })
    .first();
  private readonly addOnsPage = this.page
    .getByRole("link", { name: "Add-Ons" })
    .first();
  private readonly howToPage = this.page
    .getByRole("link", { name: "How-To" })
    .first();
  private readonly voucherPage = this.page
    .getByRole("link", { name: "Gift Voucher" })
    .first();
  private readonly franchisePage = this.page
