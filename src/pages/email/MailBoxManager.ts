...
export class MailboxManager extends BasePage {
  ...
  async login() {
    ...
    await this.page
      ...
      .fill(`${process.env.MAILBOX_ORG_EMAIL}`);
    ...
    await this.page
      ...
      .fill(`${process.env.MAILBOX_ORG_PASSWORD}`);
  ...
  async openEmailBySubject(subjectText: string) {
    const waitTime = subjectText.includes("Buchungsbestätigung")
      ? 60000
      : 20000;
    await this.page.waitForTimeout(waitTime);
    await this.page
      .getByLabel(subjectText)
      .getByText(subjectText)
      .first()
      .click();
  }
  ...
  async confirmRegistration() {
    ...
    await this.page
      .locator('iframe[title="E-Mail-Inhalt"]')
      .contentFrame()
      .getByRole("cell", { name: "E-Mailadresse bestätigen" })
      .nth(1)
      .click();
  ...
  async confirmNewsletter() {
    await this.page
      .locator('iframe[title="E-Mail-Inhalt"]')
      .contentFrame()
      .getByRole("cell", { name: "Newsletter bestätigen", exact: true })
      .click();
  }
