...
export class LoginPage extends BasePage {
  ...
  readonly registerButton = this.page.getByRole('link', { name: 'Register now' })
  ...
  readonly resetEmailInput = this.page.locator('#modal').getByRole('textbox', { name: 'E-mail address *' })
  readonly sendResetLinkButton = this.page.getByRole('button', { name: 'Send link' })
  readonly closeResetModalImg = this.page.locator('#modal').getByRole('img', { name: 'close' })
